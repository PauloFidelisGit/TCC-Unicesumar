...
import { formSchema, FormValues } from "./select-ordem-servico.schema";
...
interface Props {
  ...
  appendOrdemServico(args: FaturaFormValues["ordens_servico"][number]): void;
}
export function SelectOrdemServicoModal({
  ...
  function handleSelectData(props: FaturaFormValues["ordens_servico"][number]) {
