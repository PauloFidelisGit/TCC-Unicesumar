...
import { mapFormCreateEnderecoToApi } from "./enderecos-pessoa.dto";
import { MUTATION_CREATE_ENDERECO } from "./enderecos-pessoa.queries";
import {
...
export function NewCard({
  ...
  function setErrorsFromFormState() {
    if (form.formState.errors && "" in form.formState.errors) {
      const errors = form.formState.errors[""] as { message: string };
      setErrorsMessages([
        {
  ...
  useEffect(setErrorsFromFormState, [form.formState.errors]);
