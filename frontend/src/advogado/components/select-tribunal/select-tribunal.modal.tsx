...
import { QUERY_SEARCH_MUNICIPIO } from "./select-tribunal.queries";
import { mapQueryDTOToView } from "./selected-tribunal.dto";
import { formSchema, FormSchema } from "./selected-tribunal.schema";

interface Props {
  control: UseSelectModalControl;
}
export function SelectTribunalModal({
  ...
  const tribunal = mapQueryDTOToView(data?.searchTribunal);
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <DialogHeader>
          <DialogTitle>Selecionar Tribunal</DialogTitle>
        </DialogHeader>
        <CustomForm
          methods={form}
          onSubmit={onSubmit}
